...
<form id="save_form" action="<?php echo site_url($CI->controller_url . '/index/save'); ?>" method="post">
    ...
    <div class="row widget">
        ...
        <div class="row show-grid">
            <div class="col-xs-4">
                <label for="name" class="control-label pull-right"><?php echo $CI->lang->line('LABEL_NAME'); ?>
        ...
        <div style="" class="row show-grid">
            ...
            <div class="col-sm-4 col-xs-8">
                <select id="parent" name="item[parent]" data-placeholder="Select" class="form-control" tabindex="-1">
                    ...
                    {
                        ?>
                        <option value="<?php echo $location['id']; ?>" <?php echo ($location['id'] == $item['parent'])? 'selected':''; ?>><?php echo $location['name']; ?></option>
                    <?php
                    }
                    ?>
                </select>
        ...
        <div style="" class="row show-grid">
            <div class="col-xs-4">
                <label for="ordering" class="control-label pull-right"><?php echo $CI->lang->line('LABEL_ORDER'); ?>
                    <span style="color:#FF0000">*</span></label>
            </div>
            <div class="col-sm-4 col-xs-8">
        ...
        <div style="" class="row show-grid">
            <div class="col-xs-4">
                <label for="status" class="control-label pull-right"><?php echo $CI->lang->line('STATUS'); ?>
                    <span style="color:#FF0000">*</span></label>
            </div>
            <div class="col-sm-4 col-xs-8">
