        ...
        $("#system_jqx_container").jqxGrid(
            {
                ...
                columns:
                    [
                        ...
                        { text: '<?php echo $CI->lang->line('LABEL_STATUS_RECEIVE'); ?>',dataField: 'status_receive',width:'80',filtertype: 'list',hidden: <?php echo $system_preference_items['status_receive']?0:1;?>}
                    ]
            });
    });
</script>