        ...
        $("#system_jqx_container").jqxGrid(
            {
                ...
                columns:
                    [
                        ...
                        { text: '<?php echo $CI->lang->line('LABEL_SUPPLIER_NAME'); ?>', dataField: 'supplier_name',width:'200',filtertype: 'list', hidden: <?php echo $system_preference_items['supplier_name']?0:1;?>},
                        { text: '<?php echo $CI->lang->line('LABEL_CATEGORY_NAME'); ?>', dataField: 'category_name',width:'200',filtertype: 'list', hidden: <?php echo $system_preference_items['category_name']?0:1;?>},
